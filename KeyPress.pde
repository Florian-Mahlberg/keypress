...
void setup() {
  ...
  if (checkConnection()==true) {
    //     lose = new SoundFile(this, "https://cdn.glitch.com/990b11e5-fa32-45eb-b14e-438cfce0f05d%2F8Bit_Game_Over_1.mp3?v=1596301102235");
    //     music = new SoundFile(this, "https://cdn.glitch.com/990b11e5-fa32-45eb-b14e-438cfce0f05d%2FSandcastle.mp3?v=1598721470913");
    //     music = new SoundFile(this, "Sandcastle.wav");
    try {
      //Get Content of XML
